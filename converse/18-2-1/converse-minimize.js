                    ...
                    generateHeadingHTML: function () {
                        ...
                        if (converse.default_form) {
                            ...
                            if (button) {
                                ...
                                var edit_btn = div.querySelector('.configure-agent-chatroom-button');
                                if (edit_btn) {
                                    edit_btn.insertAdjacentHTML('afterend', el);
                                }
                            }
                        }
                ...
                ChatBoxViews: {
                    ...
                    getShownChats: function () {
                        return this.filter(function (view) {
                            ...
                            // the 'closed' state.
                            return (
                                !view.model.get('minimized') && !view.model.get('closed') &&
                                view.$el.is(':visible')
                            );
                        });
                    },
                ...
                converse.MinimizedChats = Backbone.Overview.extend({
                    ...
                    onChanged: function (item) {
                        ...
                        if (converse.default_form) {
                            ...
                            //Is not added to the folding panel, only narrow
                            if (item.get('minimized')) {
                                // this.addChat(item);
                            } else if (this.get(item.get('id'))) {
                                this.removeChat(item);
