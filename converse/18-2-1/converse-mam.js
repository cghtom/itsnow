                ...
                ChatBoxView: {
                    ...
                    fetchArchivedMessages: function (options) {
                        ...
                        converse.queryForArchivedMessages(options, function (messages) {
                            ...
                            function () {
                                this.clearSpinner();
                                console.log("Error or timeout while trying to fetch archived messages", "error");
                            }.bind(this)
                        );
                    },
            ...
            initialize: function () {
                ...
                converse.onMAMError = function (iq) {
                    if ($(iq).find('feature-not-implemented').length) {
                        console.log("Message Archive Management (XEP-0313) not supported by this browser");
                    } else {
                        console.log("An error occured while trying to set archiving preferences.");
                        console.log(iq);
                    }
                };
                ...
                converse.onMAMPreferences = function (feature, iq) {
                    ...
                    if (default_pref !== converse.message_archiving) {
                        stanza = $iq({'type': 'set'}).c('prefs', {
                            'xmlns': Strophe.NS.MAM,
                            'default': converse.message_archiving
                        });
